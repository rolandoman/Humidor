...
void sendData() {
  ...
  sprintf(databuffer, "%02d", curH1);strcat(data, databuffer);strcat(data, "\n");

  strcat(data, "hum2,owner=rolo,group=home,device=hch2 value=");
  sprintf(databuffer, "%02d", curH2);strcat(data, databuffer);strcat(data, "\n");

  strcat(data, "heatcool,owner=rolo,group=home,device=hch2 value=");
  sprintf(databuffer, "%d", heatcoolFlag);strcat(data, databuffer);strcat(data, "\n");

  strcat(data, "mist,owner=rolo,group=home,device=hch2 value=");
  sprintf(databuffer, "%d", mistFlag);strcat(data, databuffer);strcat(data, "\n");

  strcat(data, "hpower,owner=rolo,group=home,device=hch2 value=");
  sprintf(databuffer, "%03d", heaterPower);strcat(data, databuffer);strcat(data, "\n");

  strcat(data, "light,owner=rolo,group=home,device=hch2 value=");
  sprintf(databuffer, "%d", lightFlag);strcat(data, databuffer);strcat(data, "\n");
  ...
  sprintf(databuffer, "%02d", setH);strcat(data, databuffer);strcat(data, "\n");
