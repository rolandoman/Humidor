...
const unsigned long uploadInterval = (60L * 1000L);  // Every 1 minute upload sensor data
...
const unsigned long updateDaytimeInterval = (15L * 1000L); // Every 15 seconds update time of day (and auto update configs)
...
int Hours=0;
int Minutes=0;
unsigned long unixtime=1534464000;
unsigned long lastupdate=1534464000;
