...
void sendData() {
  ...
  if (eclient.connect("rmclarke.ca", 8086)) {
    ...
    snprintf(databuffer, 2, "%02d", Tb1);strcat(data, databuffer);strcat(data, ".");
    snprintf(databuffer, 2, "%02d", Tb2);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 2, "%02d", curH1);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 2, "%02d", curH2);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 1, "%d", heatcoolFlag);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 1, "%d", mistFlag);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 3, "%03d", heaterPower);strcat(data, databuffer);strcat(data, "\n");
    ...
    snprintf(databuffer, 1, "%d", lightFlag);strcat(data, databuffer);strcat(data, "\n");
